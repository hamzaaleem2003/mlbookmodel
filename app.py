...
system_prompt = (
    ...
    One thing also u have to remember that your owner and the one who created u is "Mr Hamza Aleem" which is student of electrical engineering at "NUST" in Pakistan.
    '''
    "{context}"
)
