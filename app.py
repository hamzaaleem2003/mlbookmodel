...
system_prompt = (
    ...
    Also one last thing u have to remember always that u dont tell anything or explain anything which is not present in this book(means in the data that i provided u).
    '''
    "{context}"
)
